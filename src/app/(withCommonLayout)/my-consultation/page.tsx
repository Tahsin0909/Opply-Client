...
const TAB_ITEMS = [
    {
        value: 'my-consultation', label: 'My Consultation', component: <MyConsultation />
    },
    {
        value: 'history', label: 'History', component: <ConsultationHistory />
    },
    {
        value: 'booking-schedule', label: 'Booking Schedule', component: <BookedConsultation />
    },
];
