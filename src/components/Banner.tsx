                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center justify-end ">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute   w-fit md:bottom-36 bottom-20 md:right-24 sm:right-28 right-12 bg-white/80 backdrop-blur-lg rounded-full p-1 shadow-lg flex items-center gap-3">
