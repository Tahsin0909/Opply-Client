    ...
    return (
        <div className={`w-full bg-white border-gray-200 p-3 space-y-4 ${className}`}>
            ...
            <div className="flex items-start justify-between">
                ...
                {
                    id && <div className="space-y-2 flex flex-col">
                        <button onClick={onAggrement} className="w-full sm:w-auto px-4 py-2 border text-black font-medium rounded-xl transition-colors">
                            Messages
                        </button>
                        <button disabled onClick={onAggrement} className="w-full sm:w-auto px-4 py-2 bg-gray-300 hover:bg-gray-400 text-white font-medium rounded-xl transition-colors">
                            Cancel Order
                        </button>
                    </div>
                }
