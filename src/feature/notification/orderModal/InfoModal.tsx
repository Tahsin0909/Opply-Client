...
export const InfoModal = ({ setModalState, samplePost }: { setModalState: React.Dispatch<React.SetStateAction<string>>, samplePost: any }) => {
    ...
    return (
        <div className={`w-full bg-white border-gray-200 p-6 space-y-4`}>
            ...
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Posted {samplePost.postedTime}</p>
            </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-b py-4">
                    <div>
                        <h3 className="md:text-xl text-lg font-semibold">
                            ${samplePost.priceMin} - ${samplePost.priceMax}/hr
                        </h3>
