...
const PaymentTable = () => {
  ...
  console.log("receiver payments:", receiverPayments);

  console.log("payer payments:", payerPayments);

  console.log("paymentHistory:", paymentHistory);
  console.log("paymentHistory.data.payments:", paymentHistory?.data?.payments);
  console.log("is Array:", Array.isArray(paymentHistory?.data?.payments));
