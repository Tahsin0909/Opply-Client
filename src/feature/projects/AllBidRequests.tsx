                ...
                >
                  <div className="flex items-center gap-4">
                    <Image
                      ...
                      alt={`${bid.bidUser?.firstName ?? ""} ${
                        bid.bidUser?.lastName ?? ""
                      }`}
                  ...
                  >
                    <SeeProfile
                      bio={bid.bidUser?.about?.bio || ""}
                      name={`${bid.bidUser?.firstName ?? ""} ${
                        bid.bidUser?.lastName ?? ""
                      }`}
                      ...
                      rating={bid.rating || 3.4}
                      skills={bid.bidUser?.about?.skills || []}
                      description={bid.description || "wwwrw"}
                      imageUrl={
                        bid.imageUrl || bid.bidUser?.profilePicture || "sds"
                      }
                      onMessage={() =>
                        router.push(
                          `/messaging?${encodeURIComponent(
                            `${bid.bidUser?.firstName ?? ""} ${
                              bid.bidUser?.lastName ?? ""
                            }`
                          )}`
                        )
