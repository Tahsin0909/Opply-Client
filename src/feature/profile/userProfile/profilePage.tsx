  ...
  return (
    <div className="container section-gap bg-white">
      <ProfileHeader
        profileImage={
          user?.profilePicture ??
          "https://img.freepik.com/premium-vector/silver-membership-icon-default-avatar-profile-icon-membership-icon-social-media-user-image-vector-illustration_561158-4195.jpg?ga=GA1.1.603131680.1747477038&semt=ais_items_boosted&w=740"
        }
